        ...
        >
          <div className="flex items-center justify-between mb-8">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 rounded-3xl font-bold text-white shadow-2xl hover:shadow-emerald-500/50 transition-all"
            >
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-lg text-indigo-300">
                        ...
                        <span>{selectedPatient.dosha}</span>
                      </div>
                    </div>
                    <motion.button
                      whileTap={{ scale: 0.95 }}
