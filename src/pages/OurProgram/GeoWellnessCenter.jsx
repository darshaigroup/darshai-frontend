...
const forestCentres = [
  ...
  },
  {
    ...
    shortDescription:
      "Kalari Kovilakom is located near Kollangode in the Palghat District of Kerala by the majestic Western Ghat mountain ranges. The treatment centre is located in a 200-year-old palace where history meets natural tranquility.",
    overview:
      "A restored 19th-century palace surrounded by dense forest, offering India's most exclusive classical Ayurveda retreat with no minimum stay under 14 days. All treatments are physician-prescribed, following strict Ashtavaidya traditions, with fresh herbal formulations prepared on-site. Combines regal heritage architecture with deep therapeutic immersion in a serene forest-palace setting.",
  ...
  },
  {
    ...
    geoTag: "River/Forest",
    shortDescription:
      "Softouch is located on the tranquil banks of the Chalakudy River. Village offers a forest-like atmosphere that provides the ultimate 'digital detox' and a peaceful environment for profound healing.",
    overview:
      "Nestled at the fringe of the Chalakudy river-forest ecosystem, this centre blends riverside tranquility with authentic Ayurvedic healing. Specialises in Panchakarma detox, rejuvenation therapies, and stress management, drawing on the rich biodiversity of the Chalakudy riparian belt for fresh herbal preparations. Guests benefit from cool river breezes, forest bathing trails, and intimate, personalised treatment programmes.",
  ...
  },
  {
    ...
    geoTag: "Forest/Hills",
    shortDescription:
      "Ayurveda Loka is located in the hills of Wayanad, Kerala, specifically described as being in an eco-friendly village setting surrounded by lush greenery, forest, and hills.",
    overview:
  ...
  },
  {
    ...
    geoTag: "Forest/Rural",
    shortDescription:
      "Ayurdhama is located on the border of Kerala and Karnataka, which are famous for its magnificent natural beauty, extending from the palm forests, coconut trees and to the coffee plantations around.",
    overview:
      "Set in the rural-forest landscape of Sullia in Karnataka's Western Ghats foothills, Ayurdhama offers traditional Ayurvedic treatments in a calm, unhurried environment. Programmes include Panchakarma, weight management, orthopaedic therapies, and lifestyle disease protocols delivered by experienced Ayurvedic practitioners. The surrounding medicinal-herb-rich forests and clean Sullia air create an ideal backdrop for authentic, community-rooted healing.",
  ...
  },
  {
    ...
    shortDescription:
      "Coorg Wilderness Resort & Spa is nestled within both dense forest and mountainous terrain, specifically located amid the hills and forests of the Western Ghats near Madikeri.",
    overview:
      "Perched at over 1,000 metres in Kodagu's famed coffee-estate forests, this resort combines luxurious spa therapies with the healing power of misty hill air and lush coffee and spice plantations. Offers Ayurvedic spa treatments, forest walks, bird-watching, and plantation tours alongside wellness programmes for stress relief and rejuvenation. The coffee-forest microclimate, rich in aromatic phytoncides, provides a uniquely invigorating healing environment.",
  ...
  },
  {
    ...
    geoTag: "Forest/Rural",
    shortDescription:
      "Hasanadka wellness Centre, Naturopathy, Yogatherapy, Acupuncture treatment centre situated 14kms from Sullia town with natural greenery in the middle of nature, having 4 acres of land.",
    overview:
      "A quiet, family-run Ayurvedic wellness retreat in the forest-rural landscape of Sullia Taluk, specialising in personalised Panchakarma and chronic condition management. Treatments draw on locally sourced herbs and traditional Karnataka Ayurvedic methods, supported by qualified physicians in an intimate, non-commercialised setting. Well-suited for guests seeking unhurried, cost-effective, and authentic Ayurvedic care within a natural forest environment.",
  ...
  },
  {
    ...
    geoTag: "Forest/Rural",
    shortDescription:
      "RtAyu Ayurveda Wellness Home is located in a rural, natural setting described as a farmland/ashram, Located near Sullia, Karnataka.",
    overview:
      "A home-style Ayurvedic wellness retreat in the forested heartland of Sullia Taluk, offering personalised detox, rejuvenation, and therapeutic programmes in a homely, distraction-free environment. Treatments follow classical Ayurvedic protocols using fresh, locally grown herbal ingredients, providing guests with genuine therapeutic outcomes. Ideal for first-time Ayurveda seekers and those looking for an intimate, nature-connected wellness stay.",
...
const coastalCentres = [
  ...
  },
  {
    ...
    shortDescription:
      "Chithrakoota Ayurveda is located in the mountains/hilly region, specifically nestled deep within the verdant Western Ghats. While in the hills, it is approximately 12 km from the coastal village of Maravanthe and 50 km from Udupi.",
    overview:
      "A dedicated Ayurvedic treatment centre in the coastal Kundapur zone of Karnataka, offering classical Panchakarma and disease-specific treatment programmes in a calm coastal setting. Therapies include Shirodhara, Abhyanga, Kizhi, and specialised orthopaedic and neurological treatments, all supervised by qualified Ayurvedic physicians. The coastal Kundapur climate, with its gentle sea breeze and clean air, supports superior outcomes for skin, joint, and stress-related conditions.",
  ...
  },
  {
    ...
    shortDescription:
      "Ayurjeevan Ayurveda is in Edayilakkadu, Valiyaparamba, Kerala, a peaceful riverside place surrounded by green nature, located in a coastal, backwater setting.",
    overview:
      "Uniquely positioned at the border of the coastal and forest ecosystems in Kasaragod, Ayurjeevan benefits from both the healing salinity of the sea air and the rich medicinal biodiversity of the adjoining forest belt. Offers traditional Panchakarma, detoxification, and chronic disease management programmes using locally sourced coastal and forest herbs. This rare dual-ecosystem advantage provides exceptional therapeutic inputs not available at purely coastal or purely forest wellness centres.",
...
const mountainCentres = [
  {
    ...
    shortDescription:
      "Sterling Kadumane Hills is located in the Western Ghats mountain range in Sakleshpur, Karnataka. Nestled within the lush, rolling Kadumane hills, the resort is set amidst coffee plantations, tea estates, and dense forest.",
    overview:
      "A serene mountain wellness retreat at 900 metres in Sakleshpur’s tea-estate hills, adjacent to the Bisle Ghat forest reserve within the Western Ghats. Offers Ayurvedic spa therapies, yoga, and nature walks within the property’s lush tea and coffee estates, with breathtaking misty hill views. The cool, pollution-free hill climate, rich in forest phytoncides, enhances respiratory health and makes this an ideal destination for stress recovery and gentle rejuvenation.",
    website:
      "https://www.sterlingholidays.com/resorts/sakleshpur-kadumane-hills",
  },
  {
    name: "Ananda Spa",
...
const ResortCard = ({ centre, categoryLabel, onOpen }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className="group relative h-full min-h-[420px] cursor-pointer rounded-2xl bg-white shadow-md hover:shadow-xl active:scale-[0.98] overflow-hidden transition-all duration-400"
    >
      {/* LIGHT OVERLAY */}
      <div
        className="absolute inset-0 z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-400 ease-in-out"
        style={{
          background:
      ...
      <div className="relative z-10 p-6 h-full flex flex-col justify-between">
        <div>
          {/* TITLE */}
          <h3
            className={`text-3xl font-serif font-bold leading-tight mb-2 transition-all duration-150 ease-out group-hover:text-white ${animate ? "-translate-y-1 scale-105 text-white" : "text-green-900"}`}
          >
            {centre.name}
          </h3>
          ...
          <div className="mb-4">
            <span
              className={`text-sm font-bold transition-all duration-150 ease-out inline-block group-hover:text-white/90 ${animate ? "-translate-y-1 scale-105 text-white/90" : "text-green-700"}`}
            >
              {centre.location}
            </span>
          </div>
          ...
          {/* DESCRIPTION */}
          <p
            className={`text-base font-medium leading-relaxed min-h-[170px] mb-6 transition-all duration-150 ease-out group-hover:text-white/80 ${animate ? "-translate-y-1 scale-[1.01] text-white/80" : "text-green-800/80"}`}
          >
        ...
        <div className="flex justify-end">
          <span
            className={`inline-block px-5 py-2 rounded-full text-sm font-semibold tracking-wide transition-all duration-150 ease-out ${animate ? "-translate-y-1 scale-105 bg-white text-[#174EA6]" : "bg-yellow-600 text-white"} group-hover:bg-white group-hover:text-[#174EA6]`}
          >
            Click to explore
          </span>
        </div>
...
export default function GeoWellnessCenter() {
  ...
  return (
    <div className="w-full">
      <section className="relative h-[35vh] md:h-[55vh] w-full overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={hero}
            alt="Geo Wellness Hero"
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6 lg:px-20 pt-32 md:pt-40 pb-20">
          <div
            className={`transition-all duration-700 ease-out transform ${pageLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            ...
            <h2 className="text-lg md:text-xl lg:text-2xl font-light leading-snug mb-8 max-w-4xl mx-auto">
              Exclusive Partner Locations Optimized for Circadian and
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-6 md:p-8">
                  <div>
                    ...
                    {card.caption && (
                      <p className="text-sm uppercase tracking-[0.4em] text-yellow-700 mb-4">
                        {card.caption}
                      </p>
                    )}
                  </div>
      ...
      <section className="bg-gradient-to-b from-white to-gray-50 py-24 px-6 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 text-center">
            <p className="text-xs tracking-[0.35em] text-yellow-700 uppercase mb-3">
              {meta.pageTitle}
            </p>
            <h2 className="text-4xl md:text-5xl font-serif text-green-800">
              {meta.title}
            </h2>
            <p className="mt-4 text-green-700/80 max-w-3xl mx-auto">
            ...
            >
              <div className="p-8 md:p-12">
                <div className="flex justify-end mb-4">
                  <button
                    onClick={closeModal}
                    className="text-3xl text-green-800 hover:text-yellow-700 transition-colors"
                  >
                    ×
                  </button>
                </div>
                ...
                >
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-green-900 leading-tight mb-3">
                ...
                >
                  <p className="text-green-700 text-base md:text-lg mb-8">
                    {activeSanctuary.location}
                  </p>
                </div>
                <div
                  className="animate-fade-up"
                ...
                >
                  <h3 className="text-sm uppercase tracking-[0.3em] text-yellow-700 mb-3 font-semibold">
                    Overview
                  </h3>
                  <p className="text-gray-900 leading-relaxed text-base md:text-lg">
                    {activeSanctuary.overview}
                  </p>
                </div>
                <div
