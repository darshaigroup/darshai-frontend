      ...
      render={({ field: { value, onChange } }) => (
        ...
        >
          <div
            ...
            className={`rounded-3xl border-2 border-dashed bg-[#FBFCFB] p-12 text-center transition

            ${
              errors.resume
                ? "border-red-400"
                : "border-[#BFD9C7] hover:border-[#1E7A3A]"
            }`}
          >
            ...
            <h3 className="mt-6 text-xl font-bold text-[#1E2A22]">
              Upload Your Resume
            </h3>

            <p className="mx-auto mt-3 max-w-xl text-[15px] leading-7 text-[#6A756E]">
              Drag & drop your resume here or click below to browse from your
              device.
            </p>
          ...
          {value && (
            <motion.div
              layout
              className="flex items-center justify-between rounded-2xl border border-[#DCE8DF] bg-[#F8FBF9] p-5"
            >
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#E8F7ED]">
                  <FileText size={24} className="text-[#1E7A3A]" />
                </div>

                <div>
                  <p className="font-semibold text-[#1E2A22]">{value.name}</p>

                  <p className="text-sm text-[#6E786F]">
              ...
              <button
                ...
                className="rounded-full p-3 text-red-500 transition hover:bg-red-50"
              >
                <Trash2 size={20} />
              </button>
            </motion.div>
