...
import {Briefcase,Building2,Check,Clock3,IndianRupee,MapPin,Target,Users,X} from "lucide-react";
...
const modal={
  hidden:{opacity:0,scale:.96,y:40},
  show:{
    opacity:1,
    scale:1,
    y:0,
  ...
  exit:{opacity:0,scale:.96,y:30,transition:{duration:.2}}
};
            ...
            <div className="max-h-[92vh] overflow-y-auto">
              ...
              <section className="relative overflow-hidden bg-gradient-to-br from-[#1E7A3A] via-[#256B39] to-[#163F25] px-6 py-10 text-white sm:px-10 sm:py-12">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="mt-6 max-w-4xl font-['Playfair_Display'] text-3xl font-semibold leading-tight sm:text-4xl lg:text-5xl">
                    {position.title}
                  </h2>
              ...
              <section className="space-y-10 px-6 py-8 sm:px-10 sm:py-10">
                <div className="grid gap-10 lg:grid-cols-[1.6fr_.9fr]">
                  ...
                  <div className="space-y-10">
                    ...
                    {position.success?.length>0&&(
                      <motion.div
                        initial={{opacity:0,y:18}}
                        whileInView={{opacity:1,y:0}}
                        viewport={{once:true,amount:.2}}
                        transition={{duration:.45}}
                        className="relative overflow-hidden rounded-[24px] border border-[#DCEADF] bg-gradient-to-br from-[#F8FCF9] via-white to-[#F0F8F2] p-6 sm:p-7"
                      >
                        {/* Glow */}
                        <div className="pointer-events-none absolute -right-12 -top-12 h-40 w-40 rounded-full bg-[#1E7A3A]/10 blur-3xl"/>
                        <div className="pointer-events-none absolute -bottom-16 -left-10 h-36 w-36 rounded-full bg-[#C89C37]/10 blur-3xl"/>

                        <div className="relative z-10">
                          <div className="flex items-center gap-3">
                            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-[#D8E9DC] bg-[#E8F4EB] text-[#1E7A3A]">
                              <Target size={20}/>
                            </div>

                            <div>
                              <p className="text-[10px] font-bold uppercase tracking-[.16em] text-[#7B8B80]">
                                Performance Expectations
                              </p>
                              <h3 className="mt-1 text-xl font-semibold text-[#162A1E]">
                                Success in This Role
                              </h3>
                            </div>
                          </div>
                          ...
                          <div className="mt-6 grid gap-3 sm:grid-cols-2">
                            {position.success.map((item,index)=>(
                              <motion.div
                                key={index}
                                ...
                                className="group flex items-start gap-3 rounded-2xl border border-[#E3ECE5] bg-white/90 p-4 transition duration-300 hover:-translate-y-0.5 hover:border-[#C5DEC9] hover:shadow-[0_10px_28px_rgba(30,122,58,.08)]"
                              >
                                <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#E8F4EB] text-[#1E7A3A] transition duration-300 group-hover:bg-[#1E7A3A] group-hover:text-white">
                                  <Check size={14} strokeWidth={3}/>
                                </div>

                                <p className="text-[14px] leading-6 text-[#58665E]">
                                  {item}
                                </p>
                              </motion.div>
                            ))}
                      ...
                      <div className="space-y-5">
                        ...
                        {position.salary&&(
                          <div>
                            ...
                            <p className="mt-1 font-semibold leading-6 text-[#1E7A3A]">
                              {position.salary}
                            </p>
                          </div>
                        )}
                      ...
                      <ul className="space-y-3">
                        {position.qualifications?.map((item,index)=>(
                          <li key={index} className="flex items-start gap-3">
                            <div className="mt-2 h-2 w-2 shrink-0 rounded-full bg-[#C89C37]"/>
                            <p className="leading-7 text-[#58665E]">{item}</p>
                          </li>
                        ))}
                      </ul>
