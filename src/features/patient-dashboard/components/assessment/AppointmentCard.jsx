import { CalendarDays, Clock, MapPin, Video, Phone } from "lucide-react";
    ...
    >
      <div className="flex flex-col lg:flex-row gap-5 justify-between">
        ...
        <div className="flex flex-col items-start lg:items-end gap-3">
          <span
            className={`px-3 py-1 rounded-full border text-[10px] font-semibold uppercase tracking-[0.15em] ${
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="h-10 px-4 rounded-xl border border-slate-200 dark:border-slate-700 text-sm"
            >
              Reschedule
            </button>
          </div>
