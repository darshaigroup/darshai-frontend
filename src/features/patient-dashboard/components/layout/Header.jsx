import {Search,Bell,Moon,Sun,Menu,HelpCircle,X,CheckCheck,ClipboardCheck,FileText,Stethoscope,UserCheck,LogOut} from "lucide-react";
        ...
        <div className="mx-auto flex h-24 max-w-[1520px] items-center justify-between gap-3 px-4 sm:gap-6 sm:px-6 lg:px-8">
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              title="Sign Out"
              aria-label="Sign Out"
              className="flex h-11 w-11 items-center justify-center rounded-xl border border-stone-200 bg-white transition-all hover:bg-red-50 lg:hidden"
            >
