...
import { getReportsTable, getPatientReport } from "../../Services/reportService";
...
const ReportsTable = () => {
  ...
  const ReportPill = ({ label, type, patientId, color }) => (
    <button
      onClick={() =>
        navigate(`/dashboard/report-display/${patientId}`, {
            ...
            {data.map((item) => (
              ...
              >
                ...
                <td>
                  <button
                    onClick={() =>
                      navigate(`/dashboard/report-display/${item.patient_id}`, {
                        state: {
                          reportType: "risk",
                        },
                      })
