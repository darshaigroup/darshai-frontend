...
import { clinicalDataSections } from "../sections/clinicalData/clinicalData";

import { submitClinicalData } from "../services/clinicalDataService";
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-[32px] shadow-xl p-10">
          ...
          <p className="mt-4 text-slate-500">
            Collect medical history, medications, measurements, hormonal
            indicators and wellness goals.
          </p>
        </div>
        ...
        <div className="bg-white rounded-[32px] shadow-xl p-8">
          <ClinicalDataSection
            sections={clinicalDataSections.filter(
              (section) =>
                !section.gender ||
                section.gender.toLowerCase() === patient?.gender?.toLowerCase(),
            )}
            answers={answers}
            setAnswers={(data) =>
              setAnswers((prev) => ({
        ...
        <div className="bg-white rounded-[32px] shadow-xl p-8">
          ...
          >
            {isSubmitting ? "Saving Clinical Data..." : "Submit Clinical Data"}
          </button>
        </div>
      </div>
    </AssessmentLayout>
